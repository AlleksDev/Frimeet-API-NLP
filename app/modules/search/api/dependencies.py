...
from app.modules.search.infrastructure.relevance_policy import build_relevance_policy
...
@lru_cache
def get_search_relevance_policy() -> SearchRelevancePolicy:
    return build_relevance_policy(get_settings())
...
@lru_cache
def get_search_candidates_use_case() -> SearchCandidatesUseCase:
    policy = get_search_relevance_policy()
