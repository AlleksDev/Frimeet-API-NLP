...
class DeterministicPlaceChatIntentParser:
    def __init__(self, taxonomy: PlaceChatTaxonomy | None = None) -> None:
    ...
    def parse(
        ...
        target_clause = _EXCLUSION_PATTERN.sub(" ", target_clause)
        ...
        semantic_parts = [target_category, *merged_preferences]
